...
(define-public (execute (sender principal))
	(begin
		...
		(try! (contract-call? .vde004-emergency-execute set-signals-required u1)) ;; signal from 3 out of 4 team members requied.
		...
		(try! (contract-call? .vde005-council set-approvals-required u1)) ;; approvals from 3 out of 4 team members requied.
